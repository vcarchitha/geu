...
public interface GEHUSendEmailService {
	...
	/**
	 * This method sends email to the user, the submission status once the GEHU admission form is successfully submitted. 
	 * @param emailID
	 */
	public void sendSubmissionEmailToUser(String emailID);
	
	/**
	 * This method sends email to admin once the GEHU Admission form is successfully submitted.
	 * @param formID
	 */
