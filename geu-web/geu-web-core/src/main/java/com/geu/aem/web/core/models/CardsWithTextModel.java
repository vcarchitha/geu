...
public class CardsWithTextModel {

	@Inject
	private String[] cardValues;

	private List<CardsWithTextBean> cardItemList;

	protected final static Logger log = LoggerFactory
			.getLogger(CardsWithTextModel.class);

	@PostConstruct
	public void init() {

		cardItemList = PropertiesUtil.getListFromStringArray(cardValues,
				CardsWithTextBean.class);
	}
	...
	public List<CardsWithTextBean> getCardItemList() {
		return cardItemList;
	}
