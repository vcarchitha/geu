...
@Component(service = Servlet.class, property = {
		...
		"sling.servlet.paths=" + "/bin/gehu/uploadAdmissionForm" })
public class GEHUUploadDocumentsAdmissionServlet extends SlingAllMethodsServlet {

	@Reference
	GEHUUploadAdmissionFormService gehuUploadService;

	private static final long serialVersionUID = 1L;
	private final Logger LOGGER = LoggerFactory
			.getLogger(GEHUUploadDocumentsAdmissionServlet.class);
	...
	protected void doPost(SlingHttpServletRequest request,
		...
		try {
			...
			if(isMultipart){
	            ...
	            gehuUploadService.updateUploadGEHUAdmissionData(uploadAdmissionMap,
