...
@Component(service = BasicAdmissionFormService.class, immediate = true)
public class BasicAdmissionFormServiceImpl implements BasicAdmissionFormService {

	private final Logger LOGGER = LoggerFactory
			.getLogger(BasicAdmissionFormServiceImpl.class);
	...
	public void updateBasicAdmissionData(Map<String, Object> basicAdmissionMap,
		...
		try {
			...
			LOGGER.error("NullPointerException occurred in updateBasicAdmissionData :"
					+ e.getMessage());
		} catch (IOException e) {
