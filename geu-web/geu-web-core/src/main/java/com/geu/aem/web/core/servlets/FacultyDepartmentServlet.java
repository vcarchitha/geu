...
property = { "sling.servlet.paths=" + "/bin/geu/facultyDepartment",
		"sling.servlet.methods=" + "GET", "sling.servlet.extensions=" + "json" })
public class FacultyDepartmentServlet extends SlingAllMethodsServlet {
	...
	protected void doGet(final SlingHttpServletRequest request,
		...
		Resource resource = request.getResourceResolver().getResource(ResourceConstants.FACULTY_TAG_PATH);
		if (resource != null) {
