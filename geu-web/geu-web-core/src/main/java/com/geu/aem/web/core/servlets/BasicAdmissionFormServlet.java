...
import com.geu.aem.web.core.service.BasicAdmissionFormService;
...
@Component(service = Servlet.class, property = {
	...
	"sling.servlet.paths=" + "/bin/geu/basicAdmissionForm" })
public class BasicAdmissionFormServlet extends SlingAllMethodsServlet {
	
	@Reference
	BasicAdmissionFormService admissionService;
	...
	private final Logger LOGGER = LoggerFactory
			.getLogger(BasicAdmissionFormServlet.class);
			...
			if(requestMap!=null){
				for (String basicAdmissionField : requestMap.keySet()) {
					if(basicAdmissionField.equalsIgnoreCase(ResourceConstants.FORM_ID)){
						...
						String type = ResourceConstants.GEU;
				...
				admissionService.updateBasicAdmissionData(basicAdmissionMap, request, uploadBasicFileStreamMap, 
