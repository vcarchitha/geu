...
public class CreateExcelUtil {
	...
	public static void createExcel(ArrayList<LeadBean> list, String directory) {
		...
		try {
			...
			while (itrLeadValue.hasNext()) {
				...
				if (exportLeadBean.getFormId() != null) {
					cell.setCellValue(String.valueOf(checkForNull(String
							.valueOf(exportLeadBean.getFormId()))));
				} else {
					cell.setCellValue("");
				}
				...
				cellCounter++;
				cell = row.createCell((short) cellCounter);
				if (exportLeadBean.getFollowUpDate() != null) {
					cell.setCellValue(String.valueOf(checkForNull(String
							.valueOf(exportLeadBean.getFollowUpDate()))));
				} else {
					cell.setCellValue("");
				}
				...
				cellCounter++;
				cell = row.createCell((short) cellCounter);
				if (exportLeadBean.getSource() != null) {
					cell.setCellValue(String.valueOf(checkForNull(String
							.valueOf(exportLeadBean.getSource()))));
				} else {
					cell.setCellValue("");
				}
				...
				cellCounter++;
				cell = row.createCell((short) cellCounter);
				if (exportLeadBean.getAdmissionPaymentType() != null) {
					cell.setCellValue(String.valueOf(checkForNull(String
							.valueOf(exportLeadBean.getAdmissionPaymentType()))));
				} else {
					cell.setCellValue("");
				}
				...
				cellCounter++;
				cell = row.createCell((short) cellCounter);
				if (exportLeadBean.getAdmissionFeeAmount() != null) {
					cell.setCellValue(String.valueOf(checkForNull(String
							.valueOf(exportLeadBean.getAdmissionFeeAmount()))));
				} else {
					cell.setCellValue("");
				}
				...
				cellCounter++;
				cell = row.createCell((short) cellCounter);
				if (exportLeadBean.getAdmissionPaymentStatus() != null) {
					cell.setCellValue(String.valueOf(checkForNull(String
							.valueOf(exportLeadBean.getAdmissionPaymentStatus()))));
				} else {
					cell.setCellValue("");
				}
				...
				cellCounter++;
				cell = row.createCell((short) cellCounter);
				if (exportLeadBean.getAdmissionTransactionId() != null) {
					cell.setCellValue(String.valueOf(checkForNull(String
							.valueOf(exportLeadBean.getAdmissionTransactionId()))));
				} else {
					cell.setCellValue("");
				}
				...
				cellCounter++;
				cell = row.createCell((short) cellCounter);
				if (exportLeadBean.getRegistrationPaymentMode() != null) {
					cell.setCellValue(String.valueOf(checkForNull(String
							.valueOf(exportLeadBean.getRegistrationPaymentMode()))));
				} else {
					cell.setCellValue("");
				}
				...
				cellCounter++;
				cell = row.createCell((short) cellCounter);
				if (exportLeadBean.getRegistrationFeeAmount() != null) {
					cell.setCellValue(String.valueOf(checkForNull(String
							.valueOf(exportLeadBean.getRegistrationFeeAmount()))));
				} else {
					cell.setCellValue("");
				}
				...
				cellCounter++;
				cell = row.createCell((short) cellCounter);
				if (exportLeadBean.getRegistrationPaymentStatus() != null) {
					cell.setCellValue(String.valueOf(checkForNull(String
							.valueOf(exportLeadBean.getRegistrationPaymentStatus()))));
				} else {
					cell.setCellValue("");
				}
				...
				cellCounter++;
				cell = row.createCell((short) cellCounter);
				if (exportLeadBean.getRegistrationTransactionId() != null) {
					cell.setCellValue(String.valueOf(checkForNull(String
							.valueOf(exportLeadBean.getRegistrationTransactionId()))));
				} else {
					cell.setCellValue("");
				}
			...
			LOGGER.error("Exception occurred in generateExcel method: "
					+ e.getMessage());
		}
	...
	private static void createHeader(HSSFSheet sheet) {
		try {
			...
			for (ExcelFields field : ExcelFields.values()) {
				...
				String lastModified = ExcelFields.lastModified.toString();
			...
			LOGGER.error("Exception occurred in createHeader method of GenerateExcelUtil class:: "
					+ e.getMessage());
		}
	}
